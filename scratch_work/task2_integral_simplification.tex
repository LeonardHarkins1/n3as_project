...
\begin{align*}
&I(E_f, E_i, q_0, m) = \\
&\int \frac{d^3 \vec{k}}{(2\pi)^4}\frac{1}{2\left[\omega_k - i \epsilon\right]} \times\\
&\bigg(\quad\frac{1}{
\left[(q_0 - \omega_k + i \epsilon)^2 - \omega_k^2 + i\epsilon\right]
\left[(E_i - E_f - \omega_k + i \epsilon)^2 - \omega_k^2 + i\epsilon\right]
\left[(E_f + \omega_k - i \epsilon)^2 - \omega_k^2 + i\epsilon\right]
...
\end{align*}
Expand squares, cancel $\omega_k^2$ terms, rewrite $\frac{d^3 \vec{k}}{(2\pi)^4}$ as $\frac{2 k^2 d k}{(2\pi)^3}$
\begin{align*}
&I(E_f, E_i, q_0, m) = \\
&\int \frac{k^2 d k}{(2\pi)^3}\frac{1}{\left[\omega_k - i \epsilon\right]} \times\\
&\bigg(\quad\frac{1}{
