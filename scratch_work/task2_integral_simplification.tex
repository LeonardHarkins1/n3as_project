 evaluate the contour integral over $k_0$ with the residue theorem, we need all the poles enclosed in the contour. $\int d k_0 = 2 \pi i \sum (\text{residues})$
{\bfseries minus sign for ccw integral, and $2\pi i$}
\begin{align}
...
&\quad \times \int \frac{-i d^3 \vec{k}}{(2\pi)^3}
\frac{1}{
...
\begin{align*}
&I(E_f, E_i, q_0, m) = \\
&\int \frac{-i d^3 \vec{k}}{(2\pi)^3} \times\\
...
\begin{align*}
&I(E_f, E_i, q_0, m) = \\
&\int \frac{-i d^3 \vec{k}}{(2\pi)^3}\frac{1}{2\left[\omega_k - i \epsilon\right]} \times\\
&\bigg(\quad\frac{1}{
\left[(q_0 - \omega_k + i \epsilon)^2 - \omega_k^2 + i\epsilon\right]
\left[(E_i - E_f - \omega_k + i \epsilon)^2 - \omega_k^2 + i\epsilon\right]
\left[(E_f + \omega_k - i \epsilon)^2 - \omega_k^2 + i\epsilon\right]
...
\end{align*}
Remove $\epsilon^2$ terms and group $i\epsilon$ terms
\begin{align*}
&I(E_f, E_i, q_0, m) = \\
&\int \frac{-i d^3 \vec{k}}{(2\pi)^3}\frac{1}{2\left[\omega_k - i \epsilon\right]} \times\\
&\bigg(\quad\frac{1}{
\left[(q_0 - \omega_k)^2 - \omega_k^2 + i\epsilon\right]
\left[(E_i - E_f - \omega_k)^2 - \omega_k^2 + i\epsilon\right]
\left[(E_f + \omega_k)^2 - \omega_k^2 + i\epsilon\right]
} \\
&\quad + \frac{1}{
\left[( q_0  + \omega_k)^2 - \omega_k^2 + i\epsilon\right]
\left[(E_i + -q_0  -E_f  -\omega_k )^2 - \omega_k^2 + i\epsilon\right]
\left[(q_0 + E_f + \omega_k )^2 - \omega_k^2 + i\epsilon\right]
} \\
&\quad + \frac{1}{
\left[(E_f - E_i - \omega_k)^2 - \omega_k^2 + i\epsilon\right]
\left[(q_0 + E_f - E_i - \omega_k)^2 - \omega_k^2 + i\epsilon\right]
\left[(E_i + \omega_k)^2 - \omega_k^2 + i\epsilon\right]
} \\
&\quad + \frac{1}{
\left[(E_f - \omega_k)^2 - \omega_k^2 + i\epsilon\right]
\left[(q_0 + E_f - \omega_k)^2 - \omega_k^2 + i\epsilon\right]
...
\end{align*}
Expand squares, cancel $\omega_k^2$ terms, rewrite $\frac{d^3 \vec{k}}{(2\pi)^3}$ as $\frac{2 k^2 d k}{(2\pi)^2}$
\begin{align*}
&I(E_f, E_i, q_0, m) = \\
&\int \frac{-i k^2 d k}{(2\pi)^2}\frac{1}{\left[\omega_k - i \epsilon\right]} \times\\
&\bigg(\quad\frac{1}{
